...
import source           from '#resources/env/directory-template.json' with { type: 'json' };
...
class Background
{
    ...
    {
        log.trace(`Loading image source: ${this.source.path}`)

        this.image  = await loadImage(this.source.path)
