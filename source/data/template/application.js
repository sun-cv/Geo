...
`
    ...
    message: (application) => 
    {
        const message = 
`
${Text.set(`Select Accept or decline then submit to finalize the application. Alternatively select a different clan below to queue this application to that clan (does not accept/decline)`).constrain(100, { style: ['block_code'], paddingChar: '⠀' })}
`
